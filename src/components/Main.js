        ...
        <div className="row">
          ...
          <div className="col-md-2 overflow-auto text-center" style={{ maxHeight: '768px', minWidth: '175px' }}>
            ...
            <form onSubmit={(event) => {
              ...
              &nbsp;
              <input type='file' accept=".mp4, .mkv, .ogg, .wmv" onChange={this.props.captureFile} style={{width: '250px'}}></input>
              ...
              <button type="submit" className="btn btn-danger btn-block btn-sm">Click to upload</button>
              &nbsp;
            </form>
